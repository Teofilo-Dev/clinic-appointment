    ...
    <div class="login-wrapper">
      ...
      <div class="login-card">
        <div class="card-header admin-header">
          ...
          <p class="card-subtitle">Restricted access — authorized personnel only</p>
        </div>
        ...
        <div class="card-body">
          <form @submit.prevent="handleLogin">
            ...
            <button type="submit" class="submit-btn admin-btn" :disabled="loading">
...
.login-bg {
  min-height: 100vh;
  background: linear-gradient(135deg, #1a0533, #3d0a62, #1a0533);
...
.orb-1 {
  width: 420px; height: 420px; background: #c026d3;
  top: -120px; left: -120px;
  animation: float 8s ease-in-out infinite;
}
.orb-2 {
  width: 320px; height: 320px; background: #7c3aed;
...
.icon-ring {
  ...
  display: flex; align-items: center; justify-content: center;
  margin: 0 auto 16px; box-shadow: 0 8px 24px rgba(192,38,211,0.4); font-size: 32px;
}
...
.input-field:focus {
  border-color: #c026d3; background: rgba(192,38,211,0.1);
...
.admin-btn {
  background: linear-gradient(135deg, #c026d3, #7c3aed);
  color: #fff; box-shadow: 0 8px 24px rgba(192,38,211,0.4);
}
.admin-btn:hover:not(:disabled) { transform: translateY(-2px); box-shadow: 0 12px 32px rgba(192,38,211,0.5); }
