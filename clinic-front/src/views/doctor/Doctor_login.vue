    ...
    <div class="login-wrapper">
      ...
      <div class="login-card">
        ...
        <div class="card-header doctor-header">
          ...
          <h1 class="card-title">Doctor Portal</h1>
          <p class="card-subtitle">Sign in to your medical dashboard</p>
        </div>
        ...
        <div class="card-body">
          <form @submit.prevent="handleLogin">
            ...
            <button type="submit" class="submit-btn doctor-btn" :disabled="loading">
              <span v-if="loading" class="spinner"></span>
              <span v-else>Sign In as Doctor →</span>
            </button>
          </form>
...
async function handleLogin() {
  ...
  loading.value    = true
  try {
    const res = await doctorLogin(username.value, password.value)
    successMsg.value = `Welcome, Dr. ${res.data.user.first_name || res.data.user.username}!`
...
.doctor-btn:disabled { opacity: 0.6; cursor: not-allowed; }
